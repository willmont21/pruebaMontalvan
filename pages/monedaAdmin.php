                ...
                <div class="col-md-10 col-md-offset-1">
					...
					<th>Ciudad</th>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        foreach ($DemoCollectorObj->showMonedas() as $c){
                                    ?>
                                    <tr>
                                        <td align="center">
                                            <?php
                                            echo "<a class='btn btn-default'  href='mostrarMonedas.php?id=".$c->getIdM()."'   ><em class='fa fa-pencil'></em></a>";
                                            ?>
                                            
                                            <?php
                                            echo "<a class='btn btn-danger' href='monedaEliminar.php?id=".$c->getIdM()."'><em class='fa fa-trash'></em></a>";  
                                            ?>
                                        </td>
                                        <td class="hidden-xs">  <?php  echo $c->getIdM();    ?>   </td>
                                        <td> <?php echo  $c->getNombreM(); ?> </td>
